...
class DSSM(tf.keras.Model):
    def __init__(self,
        ...
        self.user_embed_tower = TowerLayer(fc_size=fc_size,fc_activation=fc_activation,fc_drop_prob=fc_drop_prob,name='query_out_emb')
        self.item_embed_tower = TowerLayer(fc_size=fc_size,fc_activation=fc_activation,fc_drop_prob=fc_drop_prob,name='item_out_emb')
